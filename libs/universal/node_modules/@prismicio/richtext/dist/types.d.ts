...
export declare const RichTextReversedNodeType: {
    readonly "list-item": "listItem";
    readonly "o-list-item": "oListItem";
    readonly "group-list-item": "list";
    readonly "group-o-list-item": "oList";
};
