 ...
 */
export interface CustomTypeModelSlice<NonRepeatFields extends Record<string, CustomTypeModelFieldForGroup> = Record<string, CustomTypeModelFieldForGroup>, RepeatFields extends Record<string, CustomTypeModelFieldForGroup> = Record<string, CustomTypeModelFieldForGroup>> {
 ...
 * More details: {@link https://prismic.io/docs/slice}
 */
export declare const CustomTypeModelSliceDisplay: {
    readonly List: "list";
    readonly Grid: "grid";
};
/**
 ...
 */
export type CustomTypeModelLegacySlice = CustomTypeModelGroupField | CustomTypeModelFieldForGroup;
