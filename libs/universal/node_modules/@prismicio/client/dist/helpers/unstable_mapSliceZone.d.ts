 ...
 * A record of mappers.
 */
export type Mappers<TSlice extends SliceLike = SliceLike, TContext = unknown> = {
    [P in ExtractSliceType<TSlice>]: MaybeLazyModule<Mapper<Extract<TSlice, SliceLike<P>>, any, TContext>>;
};
/**
 ...
 */
export type Mapper<TSlice extends SliceLike = SliceLike, TMappedSlice extends Record<string, unknown> | undefined | void = Record<string, unknown> | undefined | void, TContext = unknown> = (args: MapperArgs<TSlice, TContext>) => TMappedSlice | Promise<TMappedSlice>;
/**
 * Arguments provided to a mapper function.
 */
export type MapperArgs<TSlice extends SliceLike = SliceLike, TContext = unknown> = SliceMapperArgs<TSlice, TContext>;
/**
 * Unwraps a lazily loaded mapper module.
 */
type ResolveLazyMapperModule<TMapper extends Mapper | LazyModule<Mapper>> = TMapper extends LazyModule<Mapper> ? Awaited<ReturnType<TMapper>> extends {
    default: unknown;
} ? Awaited<ReturnType<TMapper>>["default"] : Awaited<ReturnType<TMapper>> : TMapper;
/**
 * Transforms a Slice into its mapped version.
 */
type MapSliceLike<TSliceLike extends SliceLike, TMappers extends Mappers> = TSliceLike extends Slice ? TSliceLike["slice_type"] extends keyof TMappers ? SliceLikeRestV2<TSliceLike["slice_type"]> & MappedSliceLike & Awaited<ReturnType<ResolveLazyMapperModule<TMappers[TSliceLike["slice_type"]]>>> : TSliceLike : TSliceLike extends SliceLikeGraphQL ? TSliceLike["type"] extends keyof TMappers ? SliceLikeGraphQL<TSliceLike["type"]> & MappedSliceLike & Awaited<ReturnType<ResolveLazyMapperModule<TMappers[TSliceLike["type"]]>>> : TSliceLike : never;
/**
 ...
 */
export declare function unstable_mapSliceZone<TSliceLike extends SliceLike, TMappers extends Mappers, TContext = unknown>(sliceZone: SliceZoneLike<TSliceLike>, mappers: TMappers, context?: TContext): Promise<MapSliceLike<TSliceLike, TMappers>[]>;
export {};
