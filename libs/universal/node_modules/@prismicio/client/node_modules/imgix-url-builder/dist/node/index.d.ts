...
interface ImgixURLParams {
     ...
     */
    blendMode?: "color" | "burn" | "dodge" | "darken" | "difference" | "exclusion" | "hardlight" | "hue" | "lighten" | "luminosity" | "multiply" | "overlay" | "saturation" | "screen" | "softlight" | "normal";
    /**
     * Blend mode
     *
     * Sets the blend mode for a blend image.
     ...
     * @see https://docs.imgix.com/apis/url/blending/blend-mode
     */
    bm?: "color" | "burn" | "dodge" | "darken" | "difference" | "exclusion" | "hardlight" | "hue" | "lighten" | "luminosity" | "multiply" | "overlay" | "saturation" | "screen" | "softlight" | "normal";
    /**
     * Blend padding
     *
     ...
     */
    fm?: "gif" | "jpg" | "jp2" | "json" | "jxr" | "pjpg" | "mp4" | "png" | "png8" | "png32" | "webp" | "webm" | "blurhash" | "avif";
    /**
     * Focal point debug
     *
 ...
 */
declare const buildURL: (url: string, params: ImgixURLParams) => string;

/**
 * Parameters for `buildPixelDensitySrcSet`.
 */
type BuildPixelDensitySrcSetParams = Omit<ImgixURLParams, "dpr"> & {
    /**
 ...
 */
type BuildWidthSrcSetParams = Omit<ImgixURLParams, "width" | "w"> & {
    /**
...
declare class SecureClient {
     ...
     *   parameters applied.
     */
    buildWidthSrcSetForPath(path: string, params: BuildWidthSrcSetParams): string;
    /**
     * Builds an `<img>` `srcset` attribute value for a given set of widths for
     * the client's base URL. It can also optinally apply Imgix URL API parameters
     ...
     *   parameters applied.
     */
    buildSignedWidthSrcSetForPath(path: string, params: BuildWidthSrcSetParams): string;
    /**
     ...
     *   parameters applied.
     */
    buildSignedPixelDensitySrcSet(url: string, params: BuildPixelDensitySrcSetParams): string;
    /**
     * Builds an `<img>` `srcset` attribute value for a given set of pixel
     ...
     *   parameters applied.
     */
    buildPixelDensitySrcSetForPath(path: string, params: BuildPixelDensitySrcSetParams): string;
    /**
     * Builds an `<img>` `srcset` attribute value for a given set of pixel
     * densities for the client's base URL. It can also optinally apply Imgix URL
     ...
     *   parameters applied.
     */
    buildSignedPixelDensitySrcSetForPath(path: string, params: BuildPixelDensitySrcSetParams): string;
}
 ...
 * @see Details on securing Imgix images: https://docs.imgix.com/setup/securing-images
 */
declare const buildSignedURL: (url: string, secureURLToken: string, params: ImgixURLParams) => string;
 ...
 *   parameters applied.
 */
declare const buildSignedWidthSrcSet: (url: string, secureURLToken: string, { widths, ...params }: BuildWidthSrcSetParams) => string;
 ...
 *   parameters applied.
 */
declare const buildSignedPixelDensitySrcSet: (url: string, secureURLToken: string, { pixelDensities, ...params }: BuildPixelDensitySrcSetParams) => string;
 ...
 * @see Details on securing Imgix images: https://docs.imgix.com/setup/securing-images
 */
declare const signURL: (url: string, secureURLToken: string) => string;

export { SecureClient, SecureClientOptions, buildSignedPixelDensitySrcSet, buildSignedURL, buildSignedWidthSrcSet, buildURL, signURL };
